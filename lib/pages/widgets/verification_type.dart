...
class VerificationType extends StatelessWidget {
  const VerificationType({Key? key, required this.result, required this.tries})
      : super(key: key);
  final String result;
  final int tries;
          ...
          children: [
            if (result == "true" && tries < 3) ...[
              ...
              Padding(
                  ...
                  child: Text('The customer has been notified of your arrival.',
                      textAlign: TextAlign.center,
                      style: TextStyle(
                          fontWeight: FontWeight.bold,
              ...
              Padding(
                  padding: EdgeInsets.all(10.0),
                  child: Text('We were unable to verify your identity.',
                      textAlign: TextAlign.center,
                      style: TextStyle(
                          fontWeight: FontWeight.bold,
                          color: CupertinoColors.black,
              ...
              Padding(
                ...
                child: Column(children: [
                  Padding(
                    ...
                    child: Text(
                        'Number of attempts left: ' + (4 - tries).toString(),
                        style: TextStyle(
